...
def test_invalid_type_for_account_card_name(
    generate_random_account_card_name: Callable[[Optional[str], Optional[int]], str],
) -> None:
    ...
    if match:
        invalid_types: List[Any] = [int(match.group()), float(match.group()), None, {}, [], ()]
    else:
        invalid_types = [None, {}, [], ()]
